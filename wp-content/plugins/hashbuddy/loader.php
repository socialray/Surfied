...
function hashbuddy_post_hashtags_init() {

	add_filter( 'get_comment_text' , 'hashbuddy_posts_hashtags_filter' );
	add_filter( 'the_content', 'hashbuddy_posts_hashtags_filter' );
	add_filter( 'the_excerpt', 'hashbuddy_posts_hashtags_filter' );

}
add_action( 'wp', 'hashbuddy_post_hashtags_init', 88 );