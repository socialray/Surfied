<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<p><?php _e( 'Get #surfied!  Start and create your profile below to begin winning points towards your #surfication, prizes, sponsorships, trips, and more!', 'buddypress' ); ?></p>
